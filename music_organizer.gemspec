...
Gem::Specification.new do |spec|
  spec.name          = 'music_organizer'
  spec.version       = MusicOrganizer::VERSION
  spec.authors       = ['Vladimir Kochergin']
  spec.email         = ['kvn047@gmail.com']

  spec.summary       = 'Music Organizer'
  spec.description   = 'Organizes music files.'
